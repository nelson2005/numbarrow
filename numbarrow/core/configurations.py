...
def get_jit_options():
    ...
    than passed on. Each call reads the environment afresh; the module-level ``jit_options`` holds the value
    read when this module was first imported, and that is what the decorators use.
